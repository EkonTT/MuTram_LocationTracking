...
class SelectedPlaceScreen extends StatelessWidget {
  ...
  SelectedPlaceScreen({ Key? key, required this.routeModel})
    :super(key: key);
          ...
          children: <Widget>[
            ...
            PageView(
              ...
              children: List.generate(
                routeModel.images.length,
                    (int index) => Container(
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      fit: BoxFit.cover,
                      image: CachedNetworkImageProvider(
                          routeModel.images[index]),
                    ),
                  ),
                ),
              ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SmoothPageIndicator(
                      controller: _pageController,
                      count: routeModel.images.length,
